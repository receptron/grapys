      ...
      <div class="flex gap-2 border-b bg-gray-100 p-4">
        ...
        <div class="border-l border-gray-300 pl-2">
          <button
            ...
            :disabled="!flowStore.undoable"
            class="rounded bg-gray-500 px-4 py-2 text-white hover:bg-gray-600 disabled:cursor-not-allowed disabled:bg-gray-300"
          >
            Undo
          </button>
          <button
            @click="flowStore.redo()"
            :disabled="!flowStore.redoable"
            class="ml-2 rounded bg-gray-500 px-4 py-2 text-white hover:bg-gray-600 disabled:cursor-not-allowed disabled:bg-gray-300"
          >
            Redo
          </button>
        </div>
